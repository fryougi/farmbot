...
class Screen():
  def __init__(self, window, app='nox'):
    self.app = app
    self.window = window
...
class Farmer():
  def __init__(self, app='nox'):
    ...
    if self.app == 'nox':
      ...
      self.tmpl_menubutton = cv2.imread('templates/nox/menubutton.png')
      self.tmpl_selectsupport = cv2.imread('templates/nox/selectsupport.png')
      self.tmpl_confirmsetup = cv2.imread('templates/nox/confirmsetup.png')
      self.tmpl_startquest = cv2.imread('templates/nox/startquest.png')
      self.tmpl_attackbutton = cv2.imread('templates/nox/attackbutton.png')
      self.tmpl_mcskill = cv2.imread('templates/nox/mcskill.png')
      self.tmpl_mcskillmask = cv2.imread('templates/nox/mcskillmask.png')
      self.tmpl_replacebutton = cv2.imread('templates/nox/replacebutton.png')
      self.tmpl_nextbutton = cv2.imread('templates/nox/nextbutton.png')
      self.tmpl_apclosebutton = cv2.imread('templates/nox/apclosebutton.png')
      self.tmpl_apokbutton = cv2.imread('templates/nox/apokbutton.png')
      self.tmpl_lottoresetbox = cv2.imread('templates/nox/lottoresetbox.png')
      self.tmpl_lottoresetclose = cv2.imread('templates/nox/lottoresetclose.png')
      self.tmpl_retrybutton = cv2.imread('templates/nox/retrybutton.png')
      self.tmpl_updateclose = cv2.imread('templates/nox/updateclose.png')
      self.tmpl_fp10xsummon = cv2.imread('templates/nox/fp10xsummon.png')
      self.tmpl_fpsummonokay = cv2.imread('templates/nox/fpsummonokay.png')
      self.tmpl_fpsummoncont = cv2.imread('templates/nox/fpsummoncont.png')
      self.tmpl_fpsummonclose = cv2.imread('templates/nox/fpsummonclose.png')
      self.tmpl_fpenhancece = cv2.imread('templates/nox/fpenhancece.png')
      self.tmpl_fpenhanceokay = cv2.imread('templates/nox/fpenhanceokay.png')
      # CEs (for full resolution, each location needs its own template)
      self.tmpl_ce_lunchtime1 = cv2.imread('templates/nox/ce/lunchtime1.png')
      self.tmpl_ce_lunchtime2 = cv2.imread('templates/nox/ce/lunchtime2.png')
      self.tmpl_ce_monalisa1 = cv2.imread('templates/nox/ce/monalisa1.png')
      self.tmpl_ce_monalisa2 = cv2.imread('templates/nox/ce/monalisa2.png')
      self.tmpl_ce_nerocheer1 = cv2.imread('templates/nox/ce/nerocheer1.png')
      self.tmpl_ce_nerocheer2 = cv2.imread('templates/nox/ce/nerocheer2.png')
      self.tmpl_ce_xmasmerry1 = cv2.imread('templates/nox/ce/xmasmerry1.png')
      self.tmpl_ce_xmasmerry2 = cv2.imread('templates/nox/ce/xmasmerry2.png')
      self.tmpl_ce_davincisoc1 = cv2.imread('templates/nox/ce/davincisoc1.png')
      self.tmpl_ce_davincisoc2 = cv2.imread('templates/nox/ce/davincisoc2.png')
    elif self.app == 'blue':
      # List of template locations in window
